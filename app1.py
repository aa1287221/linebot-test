...
line_bot_api = LineBotApi('GTDZye7QZhDFNGxZuvI5+REsoExmyWiG7KOH72VkqNAKYI0gHuNvakkoaJh2EamsmDV300Vgc8TXsDybNLQib4+GyADlZywhbgU0Rh0w9AsuTbiOfNv/bO/8zeObs+yVQRFSETOw+5yU1fntgHTexgdB04t89/1O/w1cDnyilFU=')
# Channel Secret
handler = WebhookHandler('8449bb9f0f0f68227512ceb04abcb968')
...
def main():
    p1=mp.Process(target=line,args=())
    p1.start()
    
    p2=mp.Process(target=run_time,args=())
    p2.start()
